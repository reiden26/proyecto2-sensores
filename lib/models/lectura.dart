...
class LecturaCreate {
  ...
  factory LecturaCreate.fromJson(Map<String, dynamic> json) => _$LecturaCreateFromJson(json);
...
class LecturaCreateDevice {
  ...
  factory LecturaCreateDevice.fromJson(Map<String, dynamic> json) => _$LecturaCreateDeviceFromJson(json);
...
class LecturasUsuario {
  ...
  factory LecturasUsuario.fromJson(Map<String, dynamic> json) => _$LecturasUsuarioFromJson(json);
...
class LecturaAdmin {
  ...
  factory LecturaAdmin.fromJson(Map<String, dynamic> json) => _$LecturaAdminFromJson(json);
...
class LecturasAdmin {
  ...
  factory LecturasAdmin.fromJson(Map<String, dynamic> json) => _$LecturasAdminFromJson(json);
