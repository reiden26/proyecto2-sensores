...
class ApiService {
  ...
  Future<Map<String, dynamic>> updateUser(
    ...
    final response = await put('/usuarios/$userId', data: userData);
    return response.data as Map<String, dynamic>;
  }

  // Método para subir imagen a Cloudinary
  Future<Map<String, dynamic>> uploadImageToCloudinary(File imageFile) async {
    const String cloudinaryUrl =
        'https://api.cloudinary.com/v1_1/duzmmuisk/image/upload';
